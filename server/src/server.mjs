...
import { handleMavlinkData, simulateMavlinkData } from './services/mavlink.service.mjs';
import {
    insertPositionData,
    insertTemperatureData,
    insertBatteryData
} from './services/database.service.mjs';
import { getAllBatteryData, getLatestBatteryData, getAllTemperatureData, getLatestTemperatureData, getLatestBotData } from './services/database.service.mjs';
...
app.use(cors({
    origin: serverConfig.corsOrigin, // Allow requests only from this origin

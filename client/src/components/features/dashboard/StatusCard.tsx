...
const colorClasses = {
  orange: 'border-l-4 border-orange-600 text-orange-600',
  blue: 'border-l-4 border-blue-600 text-blue-600',
  green: 'border-l-4 border-green-600 text-green-600',
  gray: 'border-l-4 border-gray-400 text-gray-600',
  yellow: 'border-l-4 border-yellow-300 text-yellow-300',
};
...
export default function StatusCard({
  ...
  return (
    <div className={`p-4 rounded-lg ${colorClasses[color]} transition-all shadow-md`}>
